...
<template>
  <div class="all-stock-info-page">
    <!-- 搜索条件区域 -->
    <n-card class="all-stock-info-search" size="small" style="margin-bottom: 16px;text-align: left">
      <n-grid class="all-stock-info-search__grid" :cols="5" :x-gap="12" :y-gap="12">
        <n-grid-item>
